...
for scene in tuples:
    ...
    gamma(["lin_comb_cpx", 3, hh_slc, vv_slc, hv_slc, par.constant_r, par.constant_i, par.factorHH_r, par.factorHH_i, par.factorVV_r, par.factorVV_i,
         par.factorHV_r, par.factorHV_i, base + "_rr", samples, "", "", par.pixav_x, par.pixav_y, 1], path_out, path_log)

    gamma(["lin_comb_cpx", 3, vv_slc, hh_slc, hv_slc, par.constant_r, par.constant_i, par.factorVV_r, par.factorVV_i, par.factorHH_r, par.factorHH_i,
         par.factorHV_r, par.factorHV_i, base + "_ll", samples, "", "", par.pixav_x, par.pixav_y, 1], path_out, path_log)

    gamma(["lin_comb_cpx", 2, hh_slc, vv_slc, par.constant_r, par.constant_i, par.factorHH_r, par.factorHH_i, par.factorVV_r, par.factorVV_i,
