...
for scene in tuples:
    ...
    run(["multi_look", rl, hh_slc+".par", base+"_sphere", dummypar1, rlks, azlks], path_out, path_log)
    try:
        run(["diplane_helix", ll, rr, hh_slc+".par", base+"_diplane", base+"_helix", dummypar2, rlks, azlks, "-", "-", "-"], path_out, path_log)
