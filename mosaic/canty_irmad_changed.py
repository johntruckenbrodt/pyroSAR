...
from auxil_select import geneiv, Cpm
from gdalconst import GA_ReadOnly, GDT_Float32


path = "/pvdata2/john/Landsat/patrick"

# select input files
file1 = "/pvdata3/patrick/Landsat_Data/LT51130262010246/LT51130262010246.envi"
file2 = "/pvdata3/patrick/Landsat_Data/LT51130272010246/LT51130272010246.envi"

# select output filename and format
outfile = "/pvdata2/john/Landsat/patrick/test"
fmt = "ENVI"
...
pos1 = str(range(1, bands + 1))

x10, y10, cols1, rows1 = [0, 0, cols, rows]
...
pos2 = str(range(1, bands + 1))

x20, y20, cols, rows = [0, 0, cols, rows]
